...
const init = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const comment = yield (0, node_fetch_1.default)(
    ...
    const commentData =
      (_a =
        commentJson === null || commentJson === void 0
          ? void 0
          : commentJson.data) === null || _a === void 0
        ? void 0
        : _a.data;
    commentData.forEach((item, index) => {
      ...
      if (item.created_at.indexOf("分") >= 0) {
        const time =
          (_a = item.created_at) === null || _a === void 0
            ? void 0
            : _a.split("分")[0];
        if (time) {
          ...
          commentData[index].originTime = (0, dayjs_1.default)().subtract(
            time,
            "minute"
          );
          commentData[index].recordTime = newTime;
      ...
      if (item.created_at.indexOf("小时") >= 0) {
        const time =
          (_b = item.created_at) === null || _b === void 0
            ? void 0
            : _b.split("小时")[0];
        if (time) {
          const newTime = (0, dayjs_1.default)()
